...
⭐ NOTE 1: <br>We suggest using [`conda`](https://docs.conda.io/en/latest/) to manage your packages.<br>
⭐ NOTE 2: <br>To prevent conflicts between dependencies, the environment was not exported to a `.yaml` or `.txt` file. Therefore, you will need to manually install the required packages according to the guidelines.<br>
⭐ NOTE 3: <br>Using gpu version of pytorch will significantly accelerate the feature extraction procedure. Please refer to [here](https://pytorch.org/get-started/locally/) for more detailed settings.<br>
```bash
# Clone git
