...
class PointGenerator(nn.Module):
    ...
    def __init__(
        ...
        assert max_seq_len*max_buffer_len_factor % scale_factor**(fpn_levels - 1) == 0

        # save params
        self.max_seq_len = max_seq_len*max_buffer_len_factor
    ...
    def forward(self, feats):
        ...
        pts_list = []
        feat_lens = [feat.shape[-1] for feat in feats] # [24, 48, 96, 192, 384, 768]
