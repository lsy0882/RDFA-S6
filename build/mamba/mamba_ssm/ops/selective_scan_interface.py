...
class MambaInnerFnNoOutProj(torch.autograd.Function):
    ...
    def forward(ctx, xz, conv1ds, x_proj_weight, delta_proj_weight,
                ...
                C_proj_bias=None, delta_softplus=True, checkpoint_lvl=1, num_kernels=3):
    ...
    def backward(ctx, dout):
        ...
        if ctx.checkpoint_lvl == 1:
            conv1d_out_list = []
            delta_list = []
            for i in range(ctx.num_kernels):
...
def mamba_inner_fn_no_out_proj(
    ...
    A, B=None, C=None, D=None, delta_bias=None, B_proj_bias=None,
    C_proj_bias=None, delta_softplus=True, num_kernels=1
):
    return MambaInnerFnNoOutProj.apply(xz, conv1ds, x_proj_weight, delta_proj_weight,
                              A, B, C, D, delta_bias, B_proj_bias, C_proj_bias, delta_softplus, 1, num_kernels)
